...
scale_vec = 1.5 * sqrt(diag(var1)) #1
scale = scale_vec
scale[c(1)] = 3.7 * scale_vec[c(1)] # 3.4
scale[c(2)] = 1.7 * scale_vec[c(2)] # 1.5
scale[c(3)] = 3.5 * scale_vec[c(3)] # 1.8
scale[c(4)] = 5.7 * scale_vec[c(4)] # 5.5

scale.X = 0.0135 # 0.015
...
save(to_save, attr, file = "ou_linch_spike_truth_T2_1e5_try")
