...
linchpin <- function(n, init, scale_vec) {
    ...
    scale[n.X + c(1)] = 15 * scale_vec[c(1)]
    scale[n.X + c(2)] = 0.95 * scale_vec[c(2)]
    scale[n.X + c(3)] = 0.09 * scale_vec[c(3)]
    scale[n.X + c(4)] = 0.15 * scale_vec[c(4)]
...
save(to_save, file = "ou_linch_T_5_1e5_cwise_1_spikes_init_Sigma_1_by_10")
